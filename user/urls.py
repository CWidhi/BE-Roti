...
from .views import (RegisterView, EditUserView, MeView, GroupListCreateAPIView, 
                    GroupDetailAPIView, AddUserToGroupAPIView, RemoveUserFromGroupAPIView, 
                    GetAllUsersAPIView, get_all_sales)
